...
export default function WeeklySummaryCard({ weightUnit }: WeeklySummaryCardProps) {
  ...
  return (
    ...
    >
      ...
      {isEmpty ? (
        <p className="text-sm text-gray-500 py-4">No workouts this week</p>
      ) : (
        <>
          {/* Stats grid */}
