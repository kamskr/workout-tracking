...
**Active Task:** None
**Phase:** M004 planned (2026-03-11). 4 slices: S01 Leaderboards, S02 Challenges, S03 Badges, S04 Mobile Port. Next: begin S01 execution.
...
- 7 active (R015-R021) — R015/R016/R017 fully implemented pending live verification; R018/R019/R020 mapped to M004; R021 mapped to M005
...
## Next Steps
1. Begin M004/S01: Leaderboards — Backend + Web UI
2. Schema additions: leaderboardEntries table, leaderboardOptIn on profiles
3. Backend: updateLeaderboardEntries helper, getLeaderboard/getMyRank queries, finishWorkout hook
4. Web UI: /leaderboards page with exercise/period/metric filters
5. Verification: verify-s01-m04.ts proving ranking correctness across 5+ test users
